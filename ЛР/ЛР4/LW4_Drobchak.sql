...
CREATE TABLE SALES (
	SALES_ORDER_ID INT PRIMARY KEY, -- Унікальний ідентифікатор замовлення
    REVISION_NUMBER TINYINT, -- Інкремент для відстеження зміни за замовленням
    ...
    ONLINE_ORDER_FLAG TINYINT CHECK (ONLINE_ORDER_FLAG IN (0, 1)), -- Флаг онлайн замовлення
    CUSTOMER_ID INT, -- Унікальний ідентифікатор клієнта
    SALES_PERSON_ID INT, -- Унікальний ідентифікатор співробітника, який провів замовлення
    TERRITORY_ID INT, -- Унікальний ідентифікатор території
    SUB_TOTAL DECIMAL(10, 4), -- Загальна сума замовлення
...
VALUES (43659, 11, '1753-01-01 00:00:00.000', '2011-06-12', '2011-06-07', 0, 29825, 279, 5, 184590.1346, 1971.5149 ,616.0984 ,'2011-06-07 00:00:00.000'),
	...
	(43662, 8, '2011-05-31 00:00:00.000', '2011-06-12', '2011-06-07', 0, 29994, 289, 6, 28832.5289 , 2775.1646 ,867.2389 ,'2011-06-07 00:00:00.000'),
